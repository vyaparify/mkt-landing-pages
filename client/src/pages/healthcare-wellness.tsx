...
import { ArrowRight, Check, MapPin, MessageCircle, Phone, TrendingUp, Zap, Calendar, Star, Clock, Stethoscope, Activity, Dumbbell, Heart } from "lucide-react";
...
export default function HealthcareWellness() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <motion.div variants={fadeIn} className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full border border-border shadow-sm mb-6">
                ...
                <span className="text-sm font-medium text-muted-foreground">Trusted by 15,000+ local healthcare & wellness providers</span>
              </motion.div>
              ...
              <motion.h1 variants={fadeIn} className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold text-foreground leading-[1.1] mb-6">
                Online Bookings Made <span className="text-primary">Simple</span> for Healthcare & Wellness Businesses
              </motion.h1>
              
              <motion.p variants={fadeIn} className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-lg">
                No technical knowledge needed. Get discovered locally, manage appointments easily, and grow your practice — without ads or complex systems.
              </motion.p>
              
              <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-4 items-start">
                <a href="https://id.vyaparify.com/register?utm_source=metagoogle&utm_medium=landing&utm_campaign=healthcare-wellness&utm_id=vhw1225">
              ...
              <motion.div variants={fadeIn} className="mt-10 flex items-center gap-4 text-sm text-muted-foreground">
                ...
                <p>Join other healthcare providers in your area</p>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <img 
                src={heroImage} 
                alt="Happy healthcare provider using smartphone" 
      ...
      <section className="py-12 bg-white border-y border-border overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Used by clinics, gyms & wellness studios across India
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Most healthcare & wellness providers struggle with technology, visibility, and appointment management. We've simplified it.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow bg-secondary/30">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Websites, booking tools, and apps feel confusing and time-consuming.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow bg-secondary/30">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3">Low Patient / Member Discovery?</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Nearby patients search online but don't find accurate or updated information.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow bg-secondary/30">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3">Missed Calls & Appointments?</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Busy hours lead to missed calls, delayed responses, and lost bookings.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <p className="text-center text-lg font-semibold text-primary mt-10">
            Vyaparify is built for healthcare & wellness providers - not IT experts
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                No software training required. If you can use WhatsApp, you can use Vyaparify.
              </p>
              
              <ul className="space-y-4">
                {[
                  "No technical knowledge required",
                  "Create your clinic or studio page easily",
                  "Accept appointment requests & enquiries",
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-heading font-bold mb-6">Patients & Members From <br />Your Local Area</h2>
              <p className="text-lg text-muted-foreground mb-8">
                People nearby are searching every day for clinics, dentists, gyms, and yoga studios. Make it easy for them to find and contact you.
              </p>
              ...
              <div className="bg-secondary/30 p-6 rounded-2xl mb-4 border border-border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Get discovered when patients search for healthcare nearby.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-secondary/30 p-6 rounded-2xl mb-4 border border-border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-1">Share Your Page on WhatsApp</h4>
                    <p className="text-sm text-muted-foreground">Share your practice page with patients easily.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-secondary/30 p-6 rounded-2xl border border-border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Let patients reach you with one tap.</p>
                  </div>
                </div>
              </div>
              
              <a href="https://id.vyaparify.com/register?utm_source=metagoogle&utm_medium=landing&utm_campaign=healthcare-wellness&utm_id=vhw1225" className="inline-block mt-8">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-heading font-bold mb-4">Real Google Rankings, Real Growth</h2>
            <p className="text-muted-foreground text-lg">
              Join 10,000+ healthcare & wellness providers getting enquiries from Google.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border border-gray-200 rounded-2xl hover:shadow-lg transition-shadow">
              <CardContent className="p-8 space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  "Patients now find my clinic easily and book appointments directly."
                </p>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold">Dr. Mehta</h4>
                    <p className="text-xs text-muted-foreground">Clinic Owner, Mumbai</p>
                  </div>
                </div>
            ...
            <Card className="border border-gray-200 rounded-2xl hover:shadow-lg transition-shadow">
              <CardContent className="p-8 space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  "Our yoga studio gets regular membership enquiries without ads."
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center font-bold text-gray-600">
                    A
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Yoga Studio Owner, Pune</p>
                  </div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 space-y-2 text-sm">
                  <div className="flex justify-between items-center">
            ...
            <Card className="border border-gray-200 rounded-2xl hover:shadow-lg transition-shadow">
              <CardContent className="p-8 space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  "My dental clinic now gets bookings directly from Google. No more missed calls!"
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center font-bold text-gray-600">
                    R
                  ...
                  <div>
                    <h4 className="font-bold">Dr. Rajan</h4>
                    <p className="text-xs text-muted-foreground">Dental Clinic, Hyderabad</p>
                  </div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 space-y-2 text-sm">
                  <div className="flex justify-between items-center">
          ...
          <div className="text-center mt-12">
            <a 
              href="https://id.vyaparify.com/register?utm_source=metagoogle&utm_medium=landing&utm_campaign=healthcare-wellness&utm_id=vhw1225"
              className="inline-flex items-center gap-2 text-lg font-semibold text-primary hover:text-primary/80 transition-colors"
            >
              Join 15,000+ healthcare providers → Create your page in 2 mins
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-heading font-bold mb-4">Everything You Need to Grow Your Practice Online</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              From professional practice pages to Google visibility and appointment management - we've got you covered.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group text-center">
              <div className="overflow-hidden rounded-2xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow">
                <img 
                  src={caseStudyAI} 
                  alt="Professional Practice Page" 
                  className="w-full h-64 object-cover object-top group-hover:scale-105 transition-transform duration-500"
                />
              </div>
              <h3 className="text-xl font-bold mb-3">Professional Practice Page</h3>
              <p className="text-muted-foreground leading-relaxed">
                Show services, timings, credentials, photos & contact details beautifully.
              </p>
            </div>
            ...
            <div className="group text-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Get discovered when patients search for healthcare nearby.
              </p>
            </div>
            ...
            <div className="group text-center">
              <div className="overflow-hidden rounded-2xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow">
                <img 
                  ...
                  alt="Appointment & Enquiry Management" 
                  className="w-full h-64 object-cover object-top group-hover:scale-105 transition-transform duration-500"
                />
              </div>
              <h3 className="text-xl font-bold mb-3">Appointment & Enquiry Management</h3>
              <p className="text-muted-foreground leading-relaxed">
                Track calls, bookings, and follow-ups in one place.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-heading font-bold mb-4">Perfect for Your Healthcare & Wellness Business</h2>
            <p className="text-muted-foreground">Built for all types of wellness and care providers.</p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { icon: Stethoscope, label: "Clinics & Polyclinics" },
              { icon: Activity, label: "Dental Clinics" },
              { icon: Heart, label: "Physiotherapy Centers" },
              { icon: Dumbbell, label: "Gyms & Fitness" },
              { icon: Activity, label: "Yoga & Wellness" },
            ].map((item, i) => (
              <motion.div 
                key={i}
                whileHover={{ y: -5 }}
          ...
          <div className="grid lg:grid-cols-5 gap-8 max-w-6xl mx-auto">
            <div className="lg:col-span-3 bg-slate-900 rounded-3xl p-10 lg:p-12">
              <h2 className="text-3xl lg:text-4xl font-heading font-bold text-white mb-4 leading-tight">
                Start Free — Grow Your Practice in Minutes
              </h2>
              <p className="text-slate-400 mb-8">
                Create your online presence and start receiving patient & member enquiries today.
              </p>
              ...
              <div className="bg-slate-800 rounded-xl p-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">
                    First 100 healthcare providers get free setup assistance worth ₹5,000
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 bg-white rounded-3xl p-8 lg:p-10 shadow-xl border border-border flex flex-col justify-center relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                <span className="bg-gradient-to-r from-primary to-orange-500 text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-lg">
                  Best Value for Healthcare & Wellness
                </span>
              </div>
              <p className="text-sm text-center text-muted-foreground mb-4 leading-relaxed mt-2">
                Practice page. Google visibility. Appointment & enquiry management. All in one.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            ...
            <p className="text-muted-foreground max-w-md">
              All-in-one platform for local visibility, appointments & lead management for healthcare & wellness businesses.
            </p>
          </div>
