...
import { ArrowRight, Check, MapPin, MessageCircle, Phone, TrendingUp, Zap, Calendar, Star, X, Clock, Building, Building2, Briefcase, Home, Landmark } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background font-sans overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <motion.div variants={fadeIn} className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full border border-border shadow-sm mb-6">
                ...
                <span className="text-sm font-medium text-muted-foreground">Trusted by 15,000+ local businesses across India</span>
              </motion.div>
              ...
              <motion.h1 variants={fadeIn} className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold text-foreground leading-[1.1] mb-6">
                Online Lead Generation Made <span className="text-primary">Simple</span> for Real Estate Businesses
              </motion.h1>
              
              <motion.p variants={fadeIn} className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-lg">
                No technical knowledge needed. Get discovered locally, capture quality property enquiries, and close more deals — without expensive ads or complex tools.
              </motion.p>
              
              <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-4 items-start">
                <a href="https://id.vyaparify.com/register?utm_source=metagoogle&utm_medium=landing&utm_campaign=real-estate&utm_id=vre1225">
                  <Button size="lg" className="h-16 px-10 text-xl font-bold rounded-full bg-primary hover:bg-primary/90 shadow-2xl shadow-primary/30 transform hover:scale-105 transition-all duration-200">
                    Create Your Property Page in 2 Mins
              ...
              <motion.div variants={fadeIn} className="mt-10 flex items-center gap-4 text-sm text-muted-foreground">
                ...
                <p>Join other real estate professionals in your area</p>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <img 
                src={heroImage} 
                alt="Happy real estate professional using smartphone" 
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground">New Lead</p>
                    <p className="font-bold">Site Visit Request</p>
                  </div>
                </div>
      ...
      <section className="py-12 bg-white border-y border-border overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Used by brokers, developers & agents across India
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Most real estate professionals struggle with technology, lead quality, and online visibility. We've simplified it.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow bg-secondary/30">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3">Low-Quality or Inconsistent Leads?</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Portals are expensive and enquiries are often unqualified.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow bg-secondary/30">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3">Too Much Competition Online?</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Your listings get lost among hundreds of similar properties.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow bg-secondary/30">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3">Hard to Manage Enquiries?</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Calls, WhatsApp messages, and site-visit requests come from everywhere.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <p className="text-center text-lg font-semibold text-primary mt-10">
            Vyaparify is built for real estate professionals - not tech teams
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                No websites. No complicated dashboards. If you can use WhatsApp, you can use Vyaparify.
              </p>
              
              <ul className="space-y-4">
                {[
                  "No technical knowledge required",
                  "Create your property or business page easily",
                  "Capture enquiries & site-visit requests",
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-heading font-bold mb-6">Property Enquiries From <br />Your Local Area</h2>
              <p className="text-lg text-muted-foreground mb-8">
                Buyers and tenants search online every day. Make it easy for them to find and contact you directly.
              </p>
              ...
              <div className="bg-secondary/30 p-6 rounded-2xl mb-4 border border-border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Get discovered when buyers search for properties nearby.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-secondary/30 p-6 rounded-2xl mb-4 border border-border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-1">Share Property Listings on WhatsApp</h4>
                    <p className="text-sm text-muted-foreground">Share your listings with potential buyers easily.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-secondary/30 p-6 rounded-2xl border border-border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-1">Capture Direct Calls & Enquiry Requests</h4>
                    <p className="text-sm text-muted-foreground">Let buyers reach you with one tap.</p>
                  </div>
                </div>
              </div>
              
              <a href="https://id.vyaparify.com/register?utm_source=metagoogle&utm_medium=landing&utm_campaign=real-estate&utm_id=vre1225" className="inline-block mt-8">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-heading font-bold mb-4">Real Google Rankings, Real Closings</h2>
            <p className="text-muted-foreground text-lg">
              Join 10,000+ real estate professionals generating enquiries from Google.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border border-gray-200 rounded-2xl hover:shadow-lg transition-shadow">
              <CardContent className="p-8 space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  "Clients now find me directly on Google and call for site visits."
                </p>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold">Rakesh</h4>
                    <p className="text-xs text-muted-foreground">Property Broker, Mumbai</p>
                  </div>
                </div>
            ...
            <Card className="border border-gray-200 rounded-2xl hover:shadow-lg transition-shadow">
              <CardContent className="p-8 space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  "Our project gets genuine enquiries without spending on portals."
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center font-bold text-gray-600">
                    A
                  ...
                  <div>
                    <h4 className="font-bold">Anita</h4>
                    <p className="text-xs text-muted-foreground">Real Estate Developer, Pune</p>
                  </div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 space-y-2 text-sm">
                  <div className="flex justify-between items-center">
            ...
            <Card className="border border-gray-200 rounded-2xl hover:shadow-lg transition-shadow">
              <CardContent className="p-8 space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  "My rental listings now get direct calls. No more portal fees!"
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center font-bold text-gray-600">
                    V
                  ...
                  <div>
                    <h4 className="font-bold">Vikram</h4>
                    <p className="text-xs text-muted-foreground">Rental Agent, Bangalore</p>
                  </div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 space-y-2 text-sm">
                  <div className="flex justify-between items-center">
          ...
          <div className="text-center mt-12">
            <a 
              href="https://id.vyaparify.com/register?utm_source=metagoogle&utm_medium=landing&utm_campaign=real-estate&utm_id=vre1225"
              className="inline-flex items-center gap-2 text-lg font-semibold text-primary hover:text-primary/80 transition-colors"
            >
              Join 15,000+ real estate professionals → Create your page in 2 mins
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-heading font-bold mb-4">Everything You Need to Close Deals Online</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              From professional property pages to Google visibility and lead management - we've got you covered.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group text-center">
              <div className="overflow-hidden rounded-2xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow">
                <img 
                  src={caseStudyAI} 
                  alt="Professional Property Page" 
                  className="w-full h-64 object-cover object-top group-hover:scale-105 transition-transform duration-500"
                />
              </div>
              <h3 className="text-xl font-bold mb-3">Professional Property Page</h3>
              <p className="text-muted-foreground leading-relaxed">
                Show listings, project details, photos & contact info beautifully.
              </p>
            </div>
            ...
            <div className="group text-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Get discovered when buyers search for properties nearby.
              </p>
            </div>
            ...
            <div className="group text-center">
              <div className="overflow-hidden rounded-2xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow">
                <img 
                  ...
                  alt="Lead & Enquiry Management" 
                  className="w-full h-64 object-cover object-top group-hover:scale-105 transition-transform duration-500"
                />
              </div>
              <h3 className="text-xl font-bold mb-3">Lead & Enquiry Management</h3>
              <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-heading font-bold mb-4">Perfect for Your Real Estate Business</h2>
            <p className="text-muted-foreground">Built for every type of property professional.</p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { icon: Building2, label: "Brokers & Agents" },
              { icon: Building, label: "Developers & Builders" },
              { icon: Briefcase, label: "Property Consultants" },
              { icon: Home, label: "Rental & Leasing" },
              { icon: Landmark, label: "Commercial Real Estate" },
            ].map((item, i) => (
              <motion.div 
                key={i}
                whileHover={{ y: -5 }}
          ...
          <div className="grid lg:grid-cols-5 gap-8 max-w-6xl mx-auto">
            <div className="lg:col-span-3 bg-slate-900 rounded-3xl p-10 lg:p-12">
              <h2 className="text-3xl lg:text-4xl font-heading font-bold text-white mb-4 leading-tight">
                Start Free — Get More Property Enquiries in Minutes
              </h2>
              <p className="text-slate-400 mb-8">
                Build your online presence and start receiving quality leads today.
              </p>
              ...
              <div className="bg-slate-800 rounded-xl p-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">
                    First 100 real estate professionals get free setup assistance worth ₹5,000
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 bg-white rounded-3xl p-8 lg:p-10 shadow-xl border border-border flex flex-col justify-center relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                <span className="bg-gradient-to-r from-red-500 to-orange-500 text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-lg">
                  Special Offer for Real Estate
                </span>
              </div>
              <p className="text-sm text-center text-muted-foreground mb-4 leading-relaxed mt-2">
                Property page. Google visibility. Lead & enquiry management. All in one.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            ...
            <p className="text-muted-foreground max-w-md">
              All-in-one platform for local visibility, property listings & lead management for real estate businesses.
            </p>
          </div>
